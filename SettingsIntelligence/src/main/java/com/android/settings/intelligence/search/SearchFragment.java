...
import static com.android.settings.intelligence.SettingsIntelligenceLogProto.SettingsIntelligenceEvent;
...
public class SearchFragment extends Fragment implements SearchView.OnQueryTextListener,
    ...
    public void onStart() {
        super.onStart();
        mMetricsFeatureProvider.logEvent(SettingsIntelligenceEvent.EventType.OPEN_SEARCH_PAGE.getNumber());
    }
    ...
    public void onStop() {
        super.onStop();
        mMetricsFeatureProvider.logEvent(SettingsIntelligenceEvent.EventType.LEAVE_SEARCH_PAGE.getNumber());
        final Activity activity = getActivity();
        if (activity != null && activity.isFinishing()) {
            if (mNeverEnteredQuery) {
                mMetricsFeatureProvider.logEvent(
                        SettingsIntelligenceEvent.EventType.LEAVE_SEARCH_WITHOUT_QUERY.getNumber());
            }
        }
    }
    ...
    public boolean onQueryTextChange(String query) {
        ...
        if (isEmptyQuery) {
            ...
            mMetricsFeatureProvider.logEvent(SettingsIntelligenceEvent.EventType.PERFORM_SEARCH.getNumber());
            restartLoaders();
        }
    ...
    public void onSearchResultsDisplayed(int resultCount) {
        ...
        if (resultCount == 0) {
            ...
            mMetricsFeatureProvider.logEvent(SettingsIntelligenceEvent.EventType.SHOW_SEARCH_NO_RESULT.getNumber(),
            ...
            mMetricsFeatureProvider.logEvent(SettingsIntelligenceEvent.EventType.SHOW_SEARCH_RESULT.getNumber(),
                    queryToResultLatencyMs);
        }
